...
################################################################################
## Form generated from reading UI file 'backup0NfVjVt.ui'
##
...
"}")
        ...
        self.side_widget_right.setStyleSheet(u"")
        ...
        self.gridLayout.addWidget(self.chat_list, 1, 0, 1, 1)

        self.conversation_label = QLabel(self.frame_3)
        self.conversation_label.setObjectName(u"conversation_label")
        self.conversation_label.setStyleSheet(u"font: 24pt \"American Typewriter\";")

        self.gridLayout.addWidget(self.conversation_label, 0, 0, 1, 1)

        self.menu_frame = QFrame(self.side_widget_right)
        self.menu_frame.setObjectName(u"menu_frame")
        self.menu_frame.setGeometry(QRect(0, 410, 241, 331))
        ...
        self.input_frame_2.setStyleSheet(u"")
...
"}")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 680, 524))
        ...
        self.label_6.setStyleSheet(u"font: 24pt \"American Typewriter\";")
        ...
        self.comboBox_2.setMinimumSize(QSize(0, 32))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.conversation_label.setText(QCoreApplication.translate("MainWindow", u"Conversations:", None))
