...
"""
This function converts raw LLM output to HTML format needed for UI.
"""
...
def convert_input_msg_to_html(answer):
    start_answer = answer.find("### Answer ###")
    end_answer = answer.find("#END#")
    answer = answer[start_answer + len("### Answer ###"):end_answer]
