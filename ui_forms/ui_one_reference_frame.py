...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.webEngineView.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.webEngineView.setUrl(QUrl("static/square.html"))
        ...
        self.doc_icon.setObjectName("doc_icon")
        ...
        self.horizontalSpacer = QSpacerItem(
            3, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.label_2.setPixmap(QPixmap("static/icons/icons/logo_openalex.png"))
